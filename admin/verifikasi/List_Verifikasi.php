              ...
              <div class="card-body">
                <table id="admin" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php
                $no=0;
                $query=mysqli_query($konek, "SELECT * FROM user WHERE verifikasi=0 ORDER BY id_user ASC");
                ...
                ?>
                  ...
                  <td>
                    <?php if($row['verifikasi'] == 0){ ?>
                      <a href="index.php?page=verifikasi_pendaftaran&id_user=<?php echo $row['id_user'] ?>" class="btn btn-info"><i class="fa fa-check"></i> Verifikasi</a>
                    <?php } else { ?>
                    <a href="index.php?page=verifikasi_pendaftaran&id_user=<?php echo $row['id_user'] ?>" class="btn btn-warning"><i class="fa fa-edit"></i> Edit</a>
                     <?php } ?>
