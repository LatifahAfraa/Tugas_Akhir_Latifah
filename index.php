  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link">
        <img src="lam.png" class="brand-image img-circle elevation-3" style="opacity: .5">
        <h7 class="brand-text font-weight-light">TRAFFIC LIGHT</h7>
      </a>
    ...
    <!-- Content -->
    <?php include "admin/alamat/alamat.php"; ?>
    <!-- /Content -->

    <footer class="main-footer">
      
      <b>Lampu Lalu Lintas Ramah Lansia</b><strong> &copy; 2022</strong>
